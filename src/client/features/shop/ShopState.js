...
export class ShopState extends GameState {
  ...
  restoreFromSave(gameRoot, saveData) {
    if (saveData.currentShopCards)
      gameRoot.currentShopCards = saveData.currentShopCards;
    if (saveData.currentShopRelic)
      gameRoot.currentShopRelic = saveData.currentShopRelic;
  }
}
