export const RELICS = {
  ...
  terminal_coffee_thermos: {
    id: "terminal_coffee_thermos",
    name: "Terminal Coffee Thermos",
    text: "Start each fight with Coffee Rush.",
    art: "Monk_32.png",
    hooks: {
      onBattleStart: (ctx) => {
        ctx.player.energy += 2;
        ctx.log("Your coffee thermos provides an energizing boost!");
      },
    },
  },
  haskell: {
    ...
    hooks: {
      ...
      onPlayerAttack: (ctx, st, amount) =>
        st.used ? amount : ((st.used = true), amount * 2),
    },
  },
  worst_streamer_award: {
    id: "worst_streamer_award",
    name: "Worst Streamer Award",
    ...
    hooks: {
      onBattleStart: (ctx) => {
        ...
        ctx.log(
          "Your Worst Streamer Award intimidates the enemy, making them weak!",
        );
      },
    },
  },
...
export const START_RELIC_CHOICES = [
  "kinesis",
  "vim_motions",
  "vs_code",
  "terminal_coffee_thermos",
